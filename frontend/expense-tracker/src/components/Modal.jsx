        ...
        <div className="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-100">
                ...
                <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                    ...
                    <button
                        type="button"
                        className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-3 h-8 inline-flex justify-center items-center dark:hover:bg-gray-300 dark:hover:text-gray-700 cursor-pointer"
                        onClick={onClose}
                    >
                        <svg
                            className="w-3 h-3"
